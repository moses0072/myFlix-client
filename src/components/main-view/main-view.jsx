...
export class MainView extends React.Component {
  ...
  constructor() {
    ...
    this.state = {
      movies: [
        {_id: 1, Title: 'The Godfather', Description: 'In 1945 New York City, at his daughter Connie\'s wedding to Carlo, Vito Corleone, the don of the Corleone crime family listens to requests. His youngest son, Michael, who was a Marine during World War II, introduces his girlfriend, Kay Adams, to his family at the reception.', ImagePath: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/The_Godfather_movie_logo.png'},
        ...
        {_id: 3, Title: 'Heat', Description: 'A group of professional bank robbers start to feel the heat from police when they unknowingly leave a clue at their latest heist.', ImagePath: 'https://upload.wikimedia.org/wikipedia/en/6/6c/Heatposter.jpg'}
      ],
      selectedMovie: null
    };
  }
